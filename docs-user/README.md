...
This is a separate workspace from [`docs/`](../docs), which holds the
contributor-facing technical documentation (architecture, ADRs, ...).
...
```
docker compose up docs-user   # dev server, http://localhost:4321
```
